...
public class HouseHoldTypeManagerTest {
    ...
    public final void test() {
        ...
        household1.addPerson(new MitoPerson(1,household1, MitoOccupationStatus.WORKER, null, 30, MitoGender.MALE, true, true));
        MitoHousehold household2 = new MitoHousehold(2,  4, 1);
        household2.setHomeZone(zone);
        household2.addPerson(new MitoPerson(2,household2, MitoOccupationStatus.WORKER, null, 30, MitoGender.MALE, true, true));
